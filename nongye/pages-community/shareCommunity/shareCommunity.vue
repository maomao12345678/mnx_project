<template>
	<view class="shareCommunity">
		<view class="sharePhotosFather flex-start">
			...
			<view class="shareHint" v-if="shareBlog.shareBlogPhotos.length==0">
			...
			<scroll-view 
				...
				<image class="showMyPhoto" v-for="(url,index) in shareBlog.shareBlogPhotos" :src="url"></image>
				<!-- </view> -->
		...
		<view class="shareBlogBtnFather flex-between">
